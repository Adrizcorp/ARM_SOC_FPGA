...
module soc_system_mm_interconnect_1 (
	...
	wire   [20:0] div_freq_s1_agent_m0_address;                             // div_freq_s1_agent:m0_address -> div_freq_s1_translator:uav_address
	...
	wire  [114:0] div_freq_s1_agent_rf_source_data;                         // div_freq_s1_agent:rf_source_data -> div_freq_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] div_freq_s1_agent_rsp_fifo_out_data;                      // div_freq_s1_agent_rsp_fifo:out_data -> div_freq_s1_agent:rf_sink_data
	...
	wire  [113:0] led_pio_s1_agent_rp_data;                                 // led_pio_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [113:0] dipsw_pio_s1_agent_rp_data;                               // dipsw_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [113:0] button_pio_s1_agent_rp_data;                              // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire          div_freq_s1_agent_rp_valid;                               // div_freq_s1_agent:rp_valid -> router_005:sink_valid
	wire  [113:0] div_freq_s1_agent_rp_data;                                // div_freq_s1_agent:rp_data -> router_005:sink_data
	wire          div_freq_s1_agent_rp_ready;                               // router_005:sink_ready -> div_freq_s1_agent:rp_ready
	wire          div_freq_s1_agent_rp_startofpacket;                       // div_freq_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          div_freq_s1_agent_rp_endofpacket;                         // div_freq_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> led_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // led_pio_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> button_pio_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> button_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> button_pio_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> div_freq_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> div_freq_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // div_freq_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> div_freq_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> div_freq_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> div_freq_s1_burst_adapter:sink0_endofpacket
	wire          div_freq_s1_burst_adapter_source0_valid;                  // div_freq_s1_burst_adapter:source0_valid -> div_freq_s1_agent:cp_valid
	wire  [113:0] div_freq_s1_burst_adapter_source0_data;                   // div_freq_s1_burst_adapter:source0_data -> div_freq_s1_agent:cp_data
	wire          div_freq_s1_burst_adapter_source0_ready;                  // div_freq_s1_agent:cp_ready -> div_freq_s1_burst_adapter:source0_ready
	wire    [3:0] div_freq_s1_burst_adapter_source0_channel;                // div_freq_s1_burst_adapter:source0_channel -> div_freq_s1_agent:cp_channel
	wire          div_freq_s1_burst_adapter_source0_startofpacket;          // div_freq_s1_burst_adapter:source0_startofpacket -> div_freq_s1_agent:cp_startofpacket
	wire          div_freq_s1_burst_adapter_source0_endofpacket;            // div_freq_s1_burst_adapter:source0_endofpacket -> div_freq_s1_agent:cp_endofpacket
	...
	wire          button_pio_s1_agent_rdata_fifo_out_valid;                 // button_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] button_pio_s1_agent_rdata_fifo_out_data;                  // button_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          button_pio_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_002:in_0_ready -> button_pio_s1_agent_rdata_fifo:out_ready
	...
	wire          div_freq_s1_agent_rdata_fifo_out_valid;                   // div_freq_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] div_freq_s1_agent_rdata_fifo_out_data;                    // div_freq_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          div_freq_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter_003:in_0_ready -> div_freq_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                        // avalon_st_adapter_003:out_0_valid -> div_freq_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                         // avalon_st_adapter_003:out_0_data -> div_freq_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                        // div_freq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                        // avalon_st_adapter_003:out_0_error -> div_freq_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (div_freq_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (div_freq_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (div_freq_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (div_freq_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (div_freq_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (div_freq_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (div_freq_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (div_freq_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (div_freq_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (div_freq_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (div_freq_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (div_freq_s1_burst_adapter_source0_ready)          //          .ready
	);
